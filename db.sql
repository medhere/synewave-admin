...
CREATE TABLE IF NOT EXISTS `songs` (
  ...
  `song_credits` double(8,2) NOT NULL DEFAULT '0.50',
...
CREATE TABLE IF NOT EXISTS `token_purchases` (
  ...
  `token_price` double(8,2) NOT NULL DEFAULT '0.00',
  `credits` int NOT NULL DEFAULT '0',
  `token_to_expire` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table synewave.users: ~0 rows (approximately)
INSERT INTO `users` (`id`, `unique_id`, `role`, `name`, `nickname`, `phone`, `email`, `dob`, `email_verified_at`, `password`, `wallet`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, '001', 'admin', 'Admin', 'superman', '08077665544', 'admin@admin.com', NULL, '2023-10-24 11:50:03', '$2y$10$4yYAQ9jEeh8OW9y7cEz0su53OLJ0naHXMB9XPorCCsfHpBAJ4jgf.', 0.00, '5l59deB7WyfMKdDJR2AAt9hfu60shaTKDa5qzvcw79poqvm5XXKYHJcrCEKi', '2023-10-24 11:50:03', '2023-10-24 11:50:03');
